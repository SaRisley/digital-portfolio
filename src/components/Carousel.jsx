...
const items = [
    <div key="item-1">
        <a href="https://frontend-phi-lyart.vercel.app/"><img src="images/infinityT.png" alt="infinity-trails-project" width="700px" height="500px" onDragStart={handleDragStart} role="presentation" /></a>
        <p>
    ...
    <div key="item-2">
        <a href="https://main.d1vu96kenrpefg.amplifyapp.com/"><img src="images/rockPaperScissors.png" alt="rock-paper-scissors-project" width="700px" height="500px" onDragStart={handleDragStart} role="presentation" /></a>
        <p>
        ...
        <div key="item-3">
        <a href="https://github.com/FahimIslam2410/acebook-mern-water"><img src="images/aceBook.png" alt="aceBook-project" width="700px" height="500px" onDragStart={handleDragStart} role="presentation" /></a>
        <p>
